...
public class Condition2 {
	...
	public void sleep() {
		...
		wakeup_queue.addElement(KThread.currentThread());
	...
	public void wake() {
		Lib.assertTrue(conditionLock.isHeldByCurrentThread());
		Machine.interrupt().disable();
		if (!wakeup_queue.isEmpty())
		{
			wakeup_queue.elementAt(0).ready();
			wakeup_queue.remove(0);
		}
		Machine.interrupt().enable();
	}
	...
	private Vector<KThread> wakeup_queue = new Vector<KThread>();
}
